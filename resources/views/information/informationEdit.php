            ...
            <div id="careerD">
              ...
              <div id="organizationD">
                <div><label class="labels" for="organization" id="organizationlabel">소속</label>
                  <input class="inputs" type = "text" id = "organization" value = "'.$GLOBALS['exOrganization'][$i].'"></input><br>
                </div>
              </div>
              <div id="organizationD">
                <div><label class="labels" for="exWorkLocation" id="locationlabel">위치</label>
                  <input class="inputs" type = "text" id = "exWorkLocation" value = "'.$GLOBALS['exWorkLocation'][$i].'"></input>
                </div>
              </div>
              <div id="descriptionD">
                <div><label class="labels" for="career" id="descriptionlabel">설명</label>
                  <input class="inputs" type = "text" id = "career" value = "'.$GLOBALS['Explainn'][$i].'" id = "career"></input><br>
                </div>
              </div>
            </div>';
          }
